...
PORT = 3001
SERVER_IP = "192.168.192.71"  # Fixed IP address
...
class MecanumController(Node):
    ...
    def initialize_workspaces(self):
        ...
        self.task_manager.set_workspace_location('ws1', 2.0, -0.65, -1.9)
        self.task_manager.set_workspace_location('ws2', 3.14, 0.33, -0.4)
        self.task_manager.set_workspace_location('ws3', 0.9, 0.7, 1.07)
