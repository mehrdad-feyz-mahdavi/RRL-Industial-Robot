...
#ifndef ROBOT_CONTROL_INTERFACES__SRV__DETAIL__ARM_PRESET__FUNCTIONS_H_
#define ROBOT_CONTROL_INTERFACES__SRV__DETAIL__ARM_PRESET__FUNCTIONS_H_
...
/// Initialize srv/ArmPreset message.
/**
...
/// Finalize srv/ArmPreset message.
/**
...
/// Create srv/ArmPreset message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robot_control_interfaces__srv__ArmPreset_Request__init().
...
/// Destroy srv/ArmPreset message.
/**
 * It calls
 * robot_control_interfaces__srv__ArmPreset_Request__fini()
...
/// Check for srv/ArmPreset message equality.
/**
...
/// Initialize array of srv/ArmPreset messages.
/**
...
/// Finalize array of srv/ArmPreset messages.
/**
 * It calls
 * robot_control_interfaces__srv__ArmPreset_Request__fini()
...
/// Create array of srv/ArmPreset messages.
/**
 * It allocates the memory for the array and calls
 * robot_control_interfaces__srv__ArmPreset_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ArmPreset messages.
/**
 * It calls
 * robot_control_interfaces__srv__ArmPreset_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ArmPreset message array equality.
/**
...
/// Copy an array of srv/ArmPreset messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robot_control_interfaces__srv__ArmPreset_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_control_interfaces
...
/**
 * It calls
 * robot_control_interfaces__srv__ArmPreset_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_control_interfaces
...
/**
 * It allocates the memory for the array and calls
 * robot_control_interfaces__srv__ArmPreset_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robot_control_interfaces
...
/**
 * It calls
 * robot_control_interfaces__srv__ArmPreset_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBOT_CONTROL_INTERFACES__SRV__DETAIL__ARM_PRESET__FUNCTIONS_H_
