...
class Metaclass_DetectionArray(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('my_robot_camera_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'my_robot_camera_msgs.msg.DetectionArray')
            logger.debug(
            ...
            from my_robot_camera_msgs.msg import Detection
...
class DetectionArray(metaclass=Metaclass_DetectionArray):
    ...
    _fields_and_field_types = {
        ...
        'detections': 'sequence<my_robot_camera_msgs/Detection>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['my_robot_camera_msgs', 'msg'], 'Detection')),  # noqa: E501
    )
